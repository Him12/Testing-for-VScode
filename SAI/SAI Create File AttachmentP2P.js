        ...
        try{
            ...
            context.values.forEach(function(value) {
                ...
                let customRecord = record.create({
                    type: 'customrecord_sai_p2p_attachment' //id of custom record 
                });
                // Set the fields on the custom record
                customRecord.setValue({
                    fieldId: 'custrecord_sai_p2p_document_no',
                    value: value.documentNumber
                });
                customRecord.setValue({
                    fieldId: 'custrecord_sai_p2p_transaction_type',
                    value: value.recordType
                });
                customRecord.setValue({
                    fieldId: 'custrecord_sai_p2p_internal_id',
                    value: value.internalId
                });
                customRecord.setValue({
                    fieldId: 'custrecord_sai_p2p_external_id',
                    value: value.externalId
                });
                customRecord.setValue({
                    fieldId: 'custrecord_sai_p2p_file_attachment',
