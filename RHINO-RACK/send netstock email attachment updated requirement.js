 ...
 * Description: This script sends email attachments (CSV or PDF) from the 'Netstock' folder to predefined recipients individually. It checks for file modifications and sends updated files only, tracking email sends in custom records with file names and types.
 *
 * Version History:
 * | Version | Date       | Author          | Remarks                                                          |
 * |---------|------------|-----------------|------------------------------------------------------------------|
 * | 1.0   | 2025-07-25 | Himanshu Kumar  | sends email attachments (CSV or PDF) from the 'Netstock' folder to predefined recipients |
